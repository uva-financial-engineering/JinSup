  ...
  for j in threshold:
    for k in delay:
      ...
      for m in range(1):
        ...
        cd \$PBS_O_WORKDIR\n\
        java -jar jinsup.jar --destIAProfitFile " + os.path.join(dirname, str(m + 1).zfill(2)) + ".csv --buy 1600.00 --start 300 --trade 21700 --threshold " + str(j) + " --delay " + str(k) + " --test --numIntelligentAgents " + str(i) + "\n"
